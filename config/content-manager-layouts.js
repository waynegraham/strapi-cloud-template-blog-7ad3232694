...
const contentManagerLayouts = {
  'content_types::api::work.work': {
    ...
    metadatas: {
      ...
      earliestDate: edit('Earliest year', 'Calculated/search year from Gregorian date display.'),
      latestDate: edit('Latest year', 'Calculated/search year from Gregorian date display.'),
  ...
  'content_types::api::agent.agent': {
    ...
    metadatas: {
      ...
      media: edit('Media', 'Portrait or representative image and/or video.'),
    },
  },
  ...
  'content_types::api::institution.institution': {
    ...
    metadatas: {
      ...
      image: edit('Image', 'Public institution image or logo.'),
